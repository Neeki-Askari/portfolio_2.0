...
const HomePage: React.FC = () => {
  ...
  return (
    <HomePageOuterContainer
      ref={hiddenRef}
      className={`${"home"} ${isIntersecting ? "fadeIn" : "hidden"}`}
    >
      ...
      <IntroContainer theme={theme}>
        ...
        <SubHeader>
          I am a Full Stack Software Engineer eager to solve problems with
        ...
        <LinksContainer className={theme}>
          ...
          <ButtonStyled
            ...
            onClick={() =>
              window.open("https://www.linkedin.com/in/neeki-askari/", "_blank")
            }
          >
            Connect on LinkedIn
          </ButtonStyled>
        ...
        <ButtonStyled
          ...
          onClick={() =>
            window.open("https://github.com/Neeki-Askari", "_blank")
          }
          sx={{
            marginTop: "8px",
            width: "220px",
